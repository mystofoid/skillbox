...
profit = int(input('Введите вашу сумму дохода: '))
if profit <= 10000:
    print('Ваш налог 13% равен: ', profit * 0.13)
elif 10000 < profit <= 50000:
    print('Ваш налог 20% равен: ', (profit - 10000) * 0.2 + 10000 * 0.13)
else:
    print('Ваш налог 30% равен: ', (profit - 50000) * 0.3 + (50000 - 10000) * 0.2 + 10000 * 0.13)
