...
age = int(input("Введите значение вашего возраста: "))
age *= float(1.5)
temperature = float(input("Введите значение вашей температуры тела: "))
gift = round(age * temperature, 2)
print(f"Ваш подарок в деньгах составляет: {gift}")
