...
growth = float(input("Введите значение вашего роста: "))
weight = float(input("Введите значение вашего веса: "))

bmi = round(weight / growth ** 2, 2)
print(f"Ваш индекс массы тела равен {bmi}")
if bmi < 18:
  print("У вас недостаток веса!")
elif bmi < 25:
  print("У вас с весом всё нормально.")
elif bmi < 30:
